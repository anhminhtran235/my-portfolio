    ...
    <ul>
      <li>
        <div class="card">
          ...
          <p class="info"><span class="checkmark">✔</span> Corrupti aperiam eum saepe ratione nostrum ab consectetur quo dolorum aliquid! Suscipit, sapiente!</p>
          <p class="info"><span class="checkmark">✔</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, repellendus. A, explicabo aspernatur? Deserunt, saepe.</p>
          <p class="info"><span class="checkmark">✔</span> A, explicabo aspernatur? Deserunt, saepe</p>
        </div>
      </li>
      <li>
        <div class="card">
